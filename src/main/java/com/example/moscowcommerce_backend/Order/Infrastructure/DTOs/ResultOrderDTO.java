...
public class ResultOrderDTO {
    ...
    public ResultOrderDTO(Integer id, ResultUserDTO user, String createtime, String updatetime, Double total, List<ResultProductDTO> products, PaymentType paymentMethod) {
        this.id = id;
        this.user = user;
