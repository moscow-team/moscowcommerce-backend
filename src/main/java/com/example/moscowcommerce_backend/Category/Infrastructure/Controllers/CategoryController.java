...
public class CategoryController {
  ...
  @PostMapping
  public ResponseEntity<Result<ResultCategoryDTO>> createCategory(
    ...
    try {
      ...
      return new ResponseEntity<>(
          Result.success(categoryDTO, "Categoria creada con éxito"), HttpStatus.CREATED);
  ...
  public ResponseEntity<Result<List<ResultCategoryDTO>>> getAll() {
    try {
      ...
      List<ResultCategoryDTO> categoriesDTO =
          categories.stream().map(category -> CategoryMapper.toResultFromDomain(category)).toList();
      return new ResponseEntity<>(
          Result.success(categoriesDTO, "Categorias obtenidas con éxito"), HttpStatus.OK);
    } catch (Exception e) {
      return new ResponseEntity<>(Result.failure(e.getMessage()), HttpStatus.INTERNAL_SERVER_ERROR);
    }
  }
  ...
  public ResponseEntity<Result<ResultCategoryDTO>> deleteCategory(@PathVariable Integer id) {
    try {
      ...
      return new ResponseEntity<>(
          Result.success(categoryDTO, "Categoria eliminada con éxito"), HttpStatus.OK);
  ...
  public ResponseEntity<Result<ResultCategoryDTO>> unarchivedCategory(@PathVariable Integer id) {
    try {
      ...
      ResultCategoryDTO categoryDTO = CategoryMapper.toResultFromDomain(category);
      return new ResponseEntity<>(
          Result.success(categoryDTO, "Categoria desarchivada con éxito"), HttpStatus.OK);
    } catch (CategoryNotFoundException e) {
      return new ResponseEntity<>(Result.failure(e.getMessage()), HttpStatus.NOT_FOUND);
  ...
  @PutMapping("/{id}")
  public ResponseEntity<Result<ResultCategoryDTO>> updateCategory(
      @RequestBody UpdateCategoryDTO category, @PathVariable Integer id) {
    try {
      ...
      return new ResponseEntity<>(
          Result.success(categoryDTO, "Categoria actualizada con éxito"), HttpStatus.OK);
    } catch (CategoryNotFoundException e) {
      return new ResponseEntity<>(Result.failure(e.getMessage()), HttpStatus.NOT_FOUND);
    } catch (Exception e) {
      return new ResponseEntity<>(Result.failure(e.getMessage()), HttpStatus.INTERNAL_SERVER_ERROR);
  ...
  // Get by Criteria
  @GetMapping("/filters")
  public ResponseEntity<Result<List<ResultCategoryDTO>>> getByCriteria(
      @RequestParam Map<String, String> params) {
    try {
      // Validar los parámetros de entrada
      if (params.containsKey("invalidParam")) {
        return new ResponseEntity<>(
            Result.failure("Invalid parameter: invalidParam"), HttpStatus.BAD_REQUEST);
      }
