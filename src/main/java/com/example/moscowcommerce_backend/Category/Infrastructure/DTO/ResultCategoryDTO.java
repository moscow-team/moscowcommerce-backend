...
public class ResultCategoryDTO {
    ...
    public static ResultCategoryDTO create(Integer id, String name, String description, String creationDate, String modificationDate, boolean archived, String archivedDate) {
